    ...
    for i in range(num_labels):
        ...
        if s > 2500 and s < 50000 and y > 50 and y < 100:            
            ...
            if b == -1:
                ...
                allberries.append({'x' : centroids[i][1], 'y' : centroids[i][0], 'id' : lastid, 'enc' : pos})
...
for i, berry in enumerate(allberries):
    create_new(ref, berry['enc'], i+1, 100, 0, "https://images.chinahighlights.com/allpicture/2014/07/1e41f2966e934460b3c51ea3_cp_660x340.jpg", int(berry['x']), berry['y']/imHeight*height)
